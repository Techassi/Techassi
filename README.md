...
- [Techassi/rupl](https://github.com/Techassi/rupl) - A highly customizable REPL framework for Rust (3 days ago)
...
- [antfu/case-police](https://github.com/antfu/case-police/releases/tag/v0.5.14) ([v0.5.14](https://github.com/antfu/case-police/releases/tag/v0.5.14)) - 🚨 Make the case correct, PLEASE! (6 days ago)
