...
- [refactor(stackable-versioned): Rework version enum for merged_crd](https://github.com/stackabletech/operator-rs/pull/875) on [stackabletech/operator-rs](https://github.com/stackabletech/operator-rs) (1 day ago)
- [feat(stackable-versioned): Forward selected kube args](https://github.com/stackabletech/operator-rs/pull/873) on [stackabletech/operator-rs](https://github.com/stackabletech/operator-rs) (2 days ago)
- [ci: Add pre-commit workflow](https://github.com/Techassi/binbuf/pull/6) on [Techassi/binbuf](https://github.com/Techassi/binbuf) (3 days ago)
- [feat(stackable-versioned): Use enum for merged_crd instead of str](https://github.com/stackabletech/operator-rs/pull/872) on [stackabletech/operator-rs](https://github.com/stackabletech/operator-rs) (5 days ago)
- [chore: Rename unit test functions](https://github.com/stackabletech/operator-rs/pull/870) on [stackabletech/operator-rs](https://github.com/stackabletech/operator-rs) (5 days ago)
