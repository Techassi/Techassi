...
- [chore: Update druid-opa-authorizer for 26.3](https://github.com/stackabletech/druid-opa-authorizer/pull/138) on [stackabletech/druid-opa-authorizer](https://github.com/stackabletech/druid-opa-authorizer) (3 days ago)
- [ci: Bump actions](https://github.com/stackabletech/docker-images/pull/1404) on [stackabletech/docker-images](https://github.com/stackabletech/docker-images) (3 days ago)
- [feat: Add zizmor pre-commit hook](https://github.com/stackabletech/actions/pull/95) on [stackabletech/actions](https://github.com/stackabletech/actions) (4 days ago)
- [chore: Bump actions in CI and our own actions](https://github.com/stackabletech/actions/pull/94) on [stackabletech/actions](https://github.com/stackabletech/actions) (4 days ago)
- [ci(spark): Use Ubicloud runners](https://github.com/stackabletech/docker-images/pull/1400) on [stackabletech/docker-images](https://github.com/stackabletech/docker-images) (4 days ago)

#### 📦 Latest releases I've contributed to


- [stackabletech/actions](https://github.com/stackabletech/actions/releases/tag/v0.12.2) ([v0.12.2](https://github.com/stackabletech/actions/releases/tag/v0.12.2)) - A collection of GitHub Actions used across Stackable repositories (3 days ago)
