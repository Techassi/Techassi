...
- [TheVigil/CardGame](https://github.com/TheVigil/CardGame) - HFU Game (3 days ago)
- [Techassi/rudo](https://github.com/Techassi/rudo) - A simple Markdown based note taking app for the CLI written in Rust. (4 days ago)
...
- [antfu/case-police](https://github.com/antfu/case-police/releases/tag/v0.5.6) ([v0.5.6](https://github.com/antfu/case-police/releases/tag/v0.5.6)) - 🚨 Make the case correct, PLEASE! (2 days ago)
