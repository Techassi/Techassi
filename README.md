...
- [antfu/case-police](https://github.com/antfu/case-police/releases/tag/v0.5.5) ([v0.5.5](https://github.com/antfu/case-police/releases/tag/v0.5.5)) - 🚨 Make the case correct, PLEASE! (1 day ago)
- [windicss/windicss](https://github.com/windicss/windicss/releases/tag/v3.5.6) ([v3.5.6](https://github.com/windicss/windicss/releases/tag/v3.5.6)) - Next generation utility-first CSS framework. (6 days ago)
