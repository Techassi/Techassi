...
- [Techassi/macro-fest](https://github.com/Techassi/macro-fest) - Various TypeScript types implemented in Rust with macros. (1 day ago)
- [portal-rs/portal](https://github.com/portal-rs/portal) - Portal is a DNS server written in pure Rust. Partial Go impl: portal-go (5 days ago)
...
- [uber-go/zap](https://github.com/uber-go/zap/releases/tag/v1.23.0) ([v1.23.0](https://github.com/uber-go/zap/releases/tag/v1.23.0)) - Blazing fast, structured, leveled logging in Go. (5 days ago)
