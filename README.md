...
- [docs(issue_template): Improve rolling HDFS upgrade instructions](https://github.com/stackabletech/demos/pull/432) on [stackabletech/demos](https://github.com/stackabletech/demos) (2 days ago)
- [chore(docs): Hide helm-install notes in getting-started script](https://github.com/stackabletech/opensearch-operator/pull/159) on [stackabletech/opensearch-operator](https://github.com/stackabletech/opensearch-operator) (3 days ago)
- [fix: Properly auto derive image repos](https://github.com/stackabletech/listener-operator/pull/402) on [stackabletech/listener-operator](https://github.com/stackabletech/listener-operator) (4 days ago)
- [chore: Bump Rust dependencies pre-26.7.0](https://github.com/stackabletech/zookeeper-operator/pull/1048) on [stackabletech/zookeeper-operator](https://github.com/stackabletech/zookeeper-operator) (4 days ago)
- [chore: Bump Rust dependencies pre-26.7.0](https://github.com/stackabletech/trino-operator/pull/908) on [stackabletech/trino-operator](https://github.com/stackabletech/trino-operator) (4 days ago)

#### 📦 Latest releases I've contributed to


- [stackabletech/actions](https://github.com/stackabletech/actions/releases/tag/v0.16.2) ([v0.16.2](https://github.com/stackabletech/actions/releases/tag/v0.16.2)) - A collection of GitHub Actions used across Stackable repositories (2 days ago)
- [stackabletech/docker-images](https://github.com/stackabletech/docker-images/releases/tag/boil-0.2.3-rc.1) ([boil-0.2.3-rc.1](https://github.com/stackabletech/docker-images/releases/tag/boil-0.2.3-rc.1)) - Product images for the Stackable Data Platform (6 days ago)
