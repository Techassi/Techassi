...
- [feat: Add typed scale argument to derive macro](https://github.com/kube-rs/kube/pull/1656) on [kube-rs/kube](https://github.com/kube-rs/kube) (1 day ago)
- [ci: Add k3s and RKE2 test platforms to workflow inputs](https://github.com/stackabletech/operator-templating/pull/467) on [stackabletech/operator-templating](https://github.com/stackabletech/operator-templating) (1 day ago)
- [feat(run-integration-test): Add k3s and RKE2 cluster mappings](https://github.com/stackabletech/actions/pull/21) on [stackabletech/actions](https://github.com/stackabletech/actions) (1 day ago)
- [chore: Bump pre-commit hooks](https://github.com/stackabletech/actions/pull/20) on [stackabletech/actions](https://github.com/stackabletech/actions) (1 day ago)
- [feat(run-pre-commit): Add support to install nix](https://github.com/stackabletech/actions/pull/19) on [stackabletech/actions](https://github.com/stackabletech/actions) (1 day ago)
