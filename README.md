...
- [ci(test): Test pre-commit caching run-time improvements](https://github.com/stackabletech/operator-rs/pull/1014) on [stackabletech/operator-rs](https://github.com/stackabletech/operator-rs) (2 days ago)
- [feat(run-pre-commit): Enable caching, support pre-commit pinning](https://github.com/stackabletech/actions/pull/39) on [stackabletech/actions](https://github.com/stackabletech/actions) (2 days ago)
- [docs: Add telemetry documentation page](https://github.com/stackabletech/documentation/pull/731) on [stackabletech/documentation](https://github.com/stackabletech/documentation) (2 days ago)
- [chore: Bump stackable-operator to 0.92.0](https://github.com/stackabletech/opa-operator/pull/715) on [stackabletech/opa-operator](https://github.com/stackabletech/opa-operator) (3 days ago)
- [ci(generate_prs): Set fail-fast input default value to false](https://github.com/stackabletech/operator-templating/pull/508) on [stackabletech/operator-templating](https://github.com/stackabletech/operator-templating) (3 days ago)
