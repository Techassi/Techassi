...
- [chore: Add pre-commit hook to update links in README](https://github.com/stackabletech/actions/pull/51) on [stackabletech/actions](https://github.com/stackabletech/actions) (5 days ago)
- [chore: Bump actions to latest versions](https://github.com/stackabletech/actions/pull/50) on [stackabletech/actions](https://github.com/stackabletech/actions) (5 days ago)
- [feat(run-pre-commit): Use verbose pre-commit output](https://github.com/stackabletech/actions/pull/49) on [stackabletech/actions](https://github.com/stackabletech/actions) (5 days ago)
- [fix(stackable-versioned): Emit correct match arms for version enum](https://github.com/stackabletech/operator-rs/pull/1065) on [stackabletech/operator-rs](https://github.com/stackabletech/operator-rs) (6 days ago)
...
- [stackabletech/actions](https://github.com/stackabletech/actions/releases/tag/v0.8.3) ([v0.8.3](https://github.com/stackabletech/actions/releases/tag/v0.8.3)) - A collection of GitHub Actions used across Stackable repositories (6 days ago)
